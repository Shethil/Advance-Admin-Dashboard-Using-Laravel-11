                    ...
                    <form action="{{ route('postupdate.password') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="old_password"
                                class="form-control @error('old_password') is-invalid @enderror" id="old-password"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password"
                                class="form-control @error('password') is-invalid @enderror" id="old-password"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password_confirmation"
                                ...
                                id="old-password_confirmation" placeholder="Confirm Password Confirmation">
