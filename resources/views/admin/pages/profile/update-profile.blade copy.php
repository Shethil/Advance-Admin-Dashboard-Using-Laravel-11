...
@section('page_title', 'Profile Update Page')
                ...
                <div class="card-body">
                    <form action="{{ route('postupdate.profile') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="dropify @error('user_image') is-invalid @enderror"
                                name="user_image"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="email" value="{{ $authuser->email }}"
                                class="form-control @error('email') is-invalid @enderror" id="basic-default-fullemail"
